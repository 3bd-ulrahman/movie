...
class ActorViewModel extends ViewModel
{
    ...
    public function knownForMovies()
    {
        ...
        return json_decode(
            collect($castMovies)->sortByDesc('popularity')->take(5)->map(function($movie) {
    ...
    public function credits()
    {
        ...
        return json_decode(
            collect($castMovies)->map(function($movie) {
